...
**Nota**: O arquivo de teste (`.test.tsx`) deve ser criado simultaneamente ao componente.
...
**Ao criar qualquer componente, hook ou serviço, sempre criar o teste correspondente simultaneamente.**
...
Componentes devem ser projetados para serem facilmente testáveis:
- Separe lógica de apresentação de lógica de negócios (use hooks customizados)
- Use injeção de dependências (props, context) para facilitar mocks
- Mantenha componentes pequenos e focados (mais fáceis de testar)
- Evite dependências diretas de serviços globais - passe como props ou via context
